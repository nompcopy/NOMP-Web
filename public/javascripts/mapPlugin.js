    ...
    $.each(['need', 'offer'], function(i, ticket_type) {
        ...
        $.getJSON(ticket_list_url, {}, function(tickets) {
            $.each(tickets, function(i, ticket) {
                ...
                // geocode the address by google map api
                geocoder.geocode({'address': ticket.address}, function(results, status) {
                    if (status === 'OK') {
                        
                        // retrieve coordinates (lat/lng) of address of the ticket
